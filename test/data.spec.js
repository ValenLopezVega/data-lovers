...
filtro
  porNombrePokemon:
    1.Ubicar un pokemon en especifico
    2.Ubicar un grupo de pokemones que tenga similitud con el nombre ingresado
    3.Devolver una lista vacia si no encuentra coincidencias
 */
...
describe('filtro', () => {
  ...
  describe("filtro.porNombrePokemon", () => {
    ...
    it("Ubicar un pokemon en especifico", () => {
      ...
      expect(filtro.porNombrePokemon(listaDePokemon, "venusaur")).toStrictEqual(respuesta);
    });
...
const listaDePokemon = [
  {"num": "001", "name": "bulbasaur", "generation": {
    "num": "generation i",
    "name": "kanto"
  },
...
{"num": "002","name": "ivysaur","generation": {
    "num": "generation i",
    "name": "kanto"
  },
...
{"num": "003","name": "venusaur","generation": {
    "num": "generation i",
    "name": "kanto"
  },
  "about": "There is a large flower on Venusaur's back. The flower is said to take on vivid colors if it gets plenty of nutrition and sunlight. The flower's aroma soothes the emotions of people.",
